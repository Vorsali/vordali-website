...
export const policies: Record<string, Policy> = {
  privacy: {
    title: "Privacy Policy", eyebrow: "Privacy", summary: "How Vordali collects, uses, protects, and shares information.", effective: "July 22, 2026",
    sections: [
      ...
      { title: "SMS communications and consent", body: "Transactional messages may include secure payment links, reminders, payment confirmations, and order updates. Before a message is sent, the customer affirmatively requests SMS delivery and the participating business records that request in Commit. Message frequency varies by transaction. Message and data rates may apply. Reply STOP to opt out or HELP for assistance. Mobile information and SMS consent records are not sold, rented, or shared with third parties or affiliates for their independent marketing or promotional purposes." },
