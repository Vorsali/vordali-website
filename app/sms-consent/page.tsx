...
import { Check, MessageSquareText, ShieldCheck, Smartphone, Store, UserCheck } from "lucide-react";
  ...
  return <PageShell>
    <main className="sms-policy-page">
      ...
      <section className="sms-policy-hero">
        ...
        <div className="sms-policy-badges"><span><ShieldCheck size={15}/>Transactional only</span><span><UserCheck size={15}/>Customer requested</span><span><MessageSquareText size={15}/>STOP &amp; HELP supported</span></div>
      </section>

      <section className="sms-summary-grid">
        <article><UserCheck/><h2>Customer requested</h2><p>Messages are sent only after the customer asks for a transaction-related text.</p></article>
        <article><MessageSquareText/><h2>Transactional use</h2><p>Commit is limited to payment requests, confirmations, reminders, and related status updates.</p></article>
        <article><Store/><h2>Merchant confirmation</h2><p>The merchant must record the customer’s request before the send action becomes available.</p></article>
        <article><ShieldCheck/><h2>Customer control</h2><p>Recipients may reply STOP to opt out or HELP for assistance.</p></article>
      </section>
