      ...
      <div className="collection-showcase-panel">
        <div className="collection-copy">
          <span className="collection-badge">
            {collection === "hvac" ? "PRO · HVAC COLLECTION" : collection === "plumbing" ? "PRO · PLUMBING COLLECTION" : "PRO · RESTAURANT COLLECTION"}
          </span>
          <h3>{collection === "hvac" ? "Climate Series Recovery Cylinder" : collection === "plumbing" ? "Flow Series Revenue Pressure Vessel" : "Kitchen Series Recovery Vessel"}</h3>
          <p>
            {collection === "hvac"
          ...
          <ul>
            ...
            <li>{collection === "hvac" ? "Dual-pressure Climate Series instrumentation" : collection === "plumbing" ? "Live Flow Series pressure and water instrumentation" : "Responsive liquid animations on desktop and mobile"}</li>
          </ul>
          <small>
        ...
        <div className="collection-stats">
          ...
          <article>
            <span>{collection === "hvac" ? "Jobs recovered" : collection === "plumbing" ? "Service calls recovered" : "Orders saved"}</span>
            <strong>48</strong>
          </article>
          <article>
