  ...
  return (
    <footer className="site-footer platform-footer company-footer">
      ...
      <div className="footer-link-groups">
        ...
        <span><b>Company</b><Link href="/why-vordali">Why Vordali</Link><Link href="/trust">Trust Center</Link><Link href="/support">Support</Link><a href="mailto:hello@vordali.com">Contact</a></span>
